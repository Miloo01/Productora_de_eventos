...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { date: @concert.date, participants: @concert.participants, place: @concert.place, references: @concert.references } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { date: @concert.date, participants: @concert.participants, place: @concert.place, references: @concert.references } }
